...
export default function Status(props: { status: Status }) {
  ...
  return (
    <div className="flex items-center min-h-screen py-36 bg-cover bg-no-repeat"
      style={{
        backgroundImage: `url("/images/alex_in_cave.jpg")`
      }}>
      <div className="absolute top-0 right-0 left-0 bg-gradient-to-r from-black/80 from-70% to-transparent min-h-screen 
      group-hover:transition group-hover:duration-500 transition duration-500" />
