            ...
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                ...
                <span>
                  ...
                  которую Оператор может получить о посетителях веб-сайта https://fasberry.ru
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                ...
                <span>
                  ...
                  обеспечивающих их доступность в сети интернет по сетевому адресу https://fasberry.ru;
                </span>
                <span>
                ...
                <span>
                  ...
                  Пользователю веб-сайта https://fasberry.ru;
                </span>
                <span>
                  2.9. Пользователь – любой посетитель веб-сайта https://fasberry.ru;
                </span>
                <span>
            ...
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                ...
                <span>
                  ...
                  Пользователь всегда может отказаться от получения информационных сообщений, направив Оператору письмо на адрес электронной почты support@fasberry.ru с пометкой
            ...
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                <span>
                  ...
                  расположенные на сайте https://fasberry.ru. Заполняя соответствующие формы и/или отправляя свои персональные данные Оператору,
            ...
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                ...
                <span>
                  ...
                  путем направления Оператору уведомление на адрес электронной почты Оператора support@fasberry.ru с пометкой «Актуализация персональных данных».
                </span>
                <span>
                  ...
                  направив Оператору уведомление посредством электронной почты на электронный адрес Оператора support@fasberry.ru с пометкой «Отзыв согласия на обработку персональных данных».
                </span>
              </div>
            </div>
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
            ...
            <div className="flex flex-col gap-y-4 border border-transparent dark:hover:border-white hover:duration-500 duration-500 p-4 bg-black/80 dark:bg-transparent rounded-md">
              ...
              <div className="flex flex-col text-white text-md lg:text-lg gap-y-4">
                <span>
                  ...
                  обратившись к Оператору с помощью электронной почты support@fasberry.ru.
                </span>
                <span>
                ...
                <span>
                  8.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://fasberry.ru/info/privacy.
                </span>
              </div>
            </div>
          </div>
