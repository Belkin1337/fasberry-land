...
exports.init = () => {
  return {
    ...
    set us_subscription(newUs_subscription) {
      this._us_subscription = newUs_subscription;
    },
    set us_nickname(newUs_nickname) {
      this._us_nickname = newUs_nickname;
    },
    set tel(newTel) {
      this._tel = newTel;
    },
    ...
    get us_subscription() {
      return this._us_subscription;
    },
    get us_nickname() {
      return this._us_nickname;
    },
    get ip() {
      return this._ip;
    },
    ...
    sign() {
      this._signatureForm = crypto
        .createHash("md5")
        .update(
          `${this._shopId}:${this._amount}:${this._secret1}:${this._currency}:${this._paymentId}`
        )
        .digest("hex")
        .toString();
      this._signatureNotification = crypto
        .createHash("md5")
        .update(
          `${this._shopId}:${this._amount}:${this._secret2}:${this._paymentId}`
        )
        .digest("hex")
        .toString();
    },
    ...
    create() {
      return new Promise((resolve, reject) => {
        try {
          ...
          if (this._us_nickname) {
            num = requestBody.push(`us_nickname=${this._us_nickname}`);
          }
          if (this._us_subscription) {
            num = requestBody.push(`us_subscription=${this._us_subscription}`);
          }
    ...
    orders() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request("POST", `${this._apiUrl}/orders`, requestBody).then(
    ...
    ordersCreate() {
      return new Promise((resolve, reject) => {
        try {
          ...
          if (this._us_nickname) {
            requestBody.us_nickname = this._us_nickname.toString();
          }
          if (this._us_subscription) {
            requestBody.us_subscription = this._us_subscription.toString();
          }
    ...
    withdrawalsCreate() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request(
            "POST",
            `${this._apiUrl}/withdrawals/create`,
            requestBody
          ).then((response) => resolve(response));
        } catch (e) {
          reject(e);
    ...
    balance() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request("POST", `${this._apiUrl}/balance`, requestBody).then(
            (response) => resolve(response)
          );
        } catch (e) {
          reject(e);
    ...
    currencies() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request("POST", `${this._apiUrl}/currencies`, requestBody).then(
            (response) => resolve(response)
          );
        } catch (e) {
          reject(e);
    ...
    currenciesStatus() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request(
            "POST",
            `${this._apiUrl}/currencies/${this._i}/status`,
            requestBody
          ).then((response) => resolve(response));
        } catch (e) {
          reject(e);
    ...
    withdrawalsCurrencies() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request(
            "POST",
            `${this._apiUrl}/withdrawals/currencies`,
            requestBody
          ).then((response) => resolve(response));
        } catch (e) {
          reject(e);
    ...
    shops() {
      return new Promise((resolve, reject) => {
        try {
          ...
          this._request("POST", `${this._apiUrl}/shops`, requestBody).then(
            (response) => resolve(response)
          );
        } catch (e) {
          reject(e);
