...
const support = {
  Support: {
    headers: [
      {
        level: "Уровень:", description: "Описание:",
        commands: "Команды:", functions: "Возможности:",
        more: "подробнее", price: "Цена:",
        buy: "Перейти к покупке", cancel: "Не буду покупать"
      },
    ],
    content: [
      {
        donateElement: [
          {
            ...
            description: "Аутентичная подписка, название говорит само за себя, не так ли? Если ты обладатель этой подписки, значит ты такой как ты есть, не более и не менее. Ну или просто на что хватает денег...",
            commands: [
              "/heal - самолечение",
          ...
          },
          {
            ...
            description: "Лоял. Звучит гордо? Да. Если ты решил пропустить прошлую подписку, то добро пожаловать!Это квинтэссенция всех возможностей игрока и аутентика.",
            commands: [
              "(абсолютно те же команды, как у аутентика) +",
              "/pweather - менять лично для себя погоду",
              "список дополняется...",
            ],
            functions: [
          ...
          },
          {
            ...
            description: "Патрик Бейтман? Сигма? Это круче. Все возможности аутентика и лояла в одном флаконе.",
            commands: [
              '(абсолютно те же команды, как у лояла и аутентика)',
              'больше влияния',
          ...
          {
            title: "Хелпер", level: 5, price: "переходи в дискорд проекта, далее в категорию 'обратная-связь' и канал 'заявки-хелпер'.", link: "",
            description: "Настоящими гигачадами становятся те, кому одобрят заявку на хелпера.",
            commands: [
              'все команды, связанные с модерацией сервера:',
              'возможность кика игрока,',
              'возможность лишать игрока доступа к чату,',
            ],
            functions: [
              'Эта подписка не включает в себя возможности прошлых, она является сугубо служебной.',
              'Доступ: для получения этой подписки, необходимо подать заявку в Дискорд(-е) сервера.',
            ],
          },
        ],
      }
